...
func init() {
	...
	properties := []c.ConfigProperty{
		...
		c.Simple("skipViews", "skip_views", c.SkipZeroValue),
		c.Simple("skipUsersTable", "skip_users_table", c.SkipZeroValue),
		c.Simple("partitionColumn", "partition_column", c.SkipZeroValue),
		c.Simple("partitionType", "partition_type", c.SkipZeroValue),
