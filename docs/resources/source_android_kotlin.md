---
page_title: "rudderstack_source_android_kotlin Resource - terraform-provider-rudderstack"
subcategory: ""
description: |-
...
```terraform
resource "rudderstack_source_android_kotlin" "example" {
  name = "example-android_kotlin"
}
```
